                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: Row(
                                      children: [
                                        Icon(
                                          (widget.order.isDelivery) ? Icons.delivery_dining_outlined : Icons.hail_outlined, 
                                          color:Colors.white,
                                          size: 16.0,
                                          ),
                                        Padding(
                                          padding: const EdgeInsets.symmetric(horizontal: 2.5),
                                          child: Text(
                                            (widget.order.isDelivery) ? "DELIVERY" : "PICK-UP", 
                                            style: GoogleFonts.mulish(
                                              color: Colors.white,
                                              fontWeight: FontWeight.bold,
                                              fontSize: 14.0
                                  ...
                                  Container(
                                    ...
                                    child: Row(
                                      children: [
                                        Icon(
                                          (widget.order.orderPaymentStatus == 'Paid') ? Icons.check: Icons.close, 
                                          color:Colors.white,
                                          size: 16.0,
                                        ),
                                        Padding(
                                          padding: const EdgeInsets.symmetric(horizontal: 2.5),
                                          child: Text(
                                            widget.order.orderPaymentStatus.toUpperCase(), 
                                            style: GoogleFonts.mulish(
                                              color: Colors.white,
                                              fontWeight: FontWeight.bold,
                                              fontSize: 14.0
                                                    ...
                                                    return TextButton(
                                                      onPressed: (_isLoading == true) ? null : () async {
                                                        ...
                                                        await OrderService().deleteOrder(
                                                          ...
                                                          debugPrint("Order delete successful! (${widget.order.customerId})(${widget.order.id})");
                                                          Navigator.of(context).pop();
                                                          Navigator.of(context).pop();
